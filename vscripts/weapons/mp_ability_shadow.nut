global function OnWeaponPrimaryAttack_shadow_mode
global function MpAbilityShadowModeWeapon_Init
global function MpAbilityShadowModeWeapon_OnWeaponTossPrep
global function OnWeaponDeactivate_shadow_mode

#if SERVER
global function BurnMeter_ShadowMode
#endif //SERVER
#if R5DEV && CLIENT 
global function GetShadowColorCorrectionID
#endif //
...
void function MpAbilityShadowModeWeapon_Init()
{
	#if SERVER
...
void function MpAbilityShadowModeWeapon_OnWeaponTossPrep( entity weapon, WeaponTossPrepParams prepParams )
{
...
var function OnWeaponPrimaryAttack_shadow_mode( entity weapon, WeaponPrimaryAttackParams attackParams )
{
	entity weaponOwner = weapon.GetWeaponOwner()
...
void function OnWeaponDeactivate_shadow_mode( entity weapon )
{
	entity weaponOwner = weapon.GetWeaponOwner()
...
void function BurnMeter_ShadowMode( entity player )
{
...
void function HuntMode_Start( entity player )
{
	...
	player.SetPlayerSettingsWithMods( characterSetFile, ["enable_doublejump", "enable_wallrun"] )
...
#if R5DEV && CLIENT 
int function GetShadowColorCorrectionID()
{
